...
export const EVENT_FORM = {
   ...
   */
  boundaryHint:
    "«До канікул» і «до кінця семестру» перетворюються на дату під час збереження. Якщо потім змінити дати канікул, повторення залишиться там, де його вже пораховано.",
};
